...
5) поиск и сортировка с фронта не работают
...
8) ещё раз понять - что такое залогиненный юзер, где лежат про него данные, и как их 
   использовать.
   Потом научиться их доставать, типа 'вы вошли как ...'
   Потом попробовать логаут
   Потом добавить колонки в таблице
   Потом авторизация по ролям
